...
namespace PokeManagementDAL.Migrations
{
    ...
    [Migration("20240522083527_RemoveDefaultPersonalization")]
    partial class RemoveDefaultPersonalization
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("PokeManagementDAL.Data.Personalization", b =>
                {
                    ...
                    b.HasOne("PokeManagementDAL.Data.ProductIngredient", "ProductIngredient")
                        .WithMany("Personalizations")
